    ...
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 mt-16 border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-sm">
            ...
            with Firebase, Next.js, and love 💙.
          </p>
        </div>

        <div>
          <h5 className="font-semibold mb-3 text-gray-900 dark:text-white">Links</h5>
          <ul className="space-y-1 text-sm">
            <li>
              <Link href="/" className="hover:underline">Home</Link>
            </li>
            <li>
              <Link href="/media" className="hover:underline">Explore</Link>
            </li>
            <li>
        ...
        <div>
          <h5 className="font-semibold mb-3 text-gray-900 dark:text-white">Creators</h5>
          <ul className="space-y-1 text-sm">
            <li>
              <Link href="/upload" className="hover:underline">Upload Content</Link>
            </li>
            <li>
        ...
        <div>
          <h5 className="font-semibold mb-3 text-gray-900 dark:text-white">Contact</h5>
          <ul className="space-y-1 text-sm">
            <li>Email: support@snapshare.com</li>
            <li>Twitter: @snapshare</li>
            <li>GitHub: /snapshare</li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-center text-xs py-4 border-t border-gray-200 dark:border-gray-700">
        <p className="text-gray-500 dark:text-gray-500">
          &copy; {new Date().getFullYear()} SnapShare. All rights reserved.
        </p>
      </div>
    </footer>
  );
